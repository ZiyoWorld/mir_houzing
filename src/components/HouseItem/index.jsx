    ...
    <React.Fragment>
      ...
      <Wrapper>
        <Container flex={3}>
          <Content>
            <Section>
              <Section.Title large>{data?.name}</Section.Title>
              <div className="info">
          ...
          <Content>
            <Details>
              ...
              <Icons.Calendar />
              <Details.Title>
                Area {data?.houseDetails?.yearBuilt || 0}{" "}
              </Details.Title>
            </Details>
            ...
            <Section ends>
              <Details pad>
                ...
                <Section.Title>${data?.price || 0}/mo</Section.Title>
              </Details>
              <Details.Title mar>
          ...
          <Section.Title desc>Description</Section.Title>
          <Description>
            {data?.description}
            Lorem ipsum dolor sit amet, Lorem ipsum dolor sit amet consectetur
            adipisicing elit. Tempore ipsa, tempora ratione amet beatae cum
            ipsum quos. Tenetur, eos nam. consectetur adipisicing elit.
            Cupiditate et praesentium minima, nam maxime temporibus adipisci
            vitae nostrum? Odit, natus? Quos odit, eos vitae ex id nostrum qui
            culpa corporis sapiente! Explicabo quae qui incidunt alias
            distinctio aperiam, labore facere delectus laudantium dolores in!
            Fuga, a laudantium dolore perferendis maiores facilis,
            exercitationem aspernatur necessitatibus, amet debitis officia
            sequi. Nulla cumque, voluptatem nisi ad ipsam placeat quas? Nisi
            odio rem minus quaerat incidunt dolore adipisci illum quam ducimus
            error! Earum, placeat magni iure obcaecati ab ea pariatur minus
            voluptatum perspiciatis mollitia, provident consequatur dolores
            soluta debitis voluptatem architecto repellendus nemo quos.
          </Description>
        ...
        <Container height="true" className="user" flex={1}>
          ...
          <Button width={"100%"} type={"primary"} height={44}>
            Send Request
          </Button>
        </Container>
      </Wrapper>
