  ...
  const items = [
    {
      ...
      label: (
        <MenuWrapper>
          ...
          <Section>
             <Input onChange={onChange} name="room"  defaultValue={query.get('room')} ref={roomRef} placeholder={'Rooms'} />
        ...
        <SelectAnt value={value} onChange={onChangeCategory}>
          ...
          <Section>
            <Input onChange={onChange} defaultValue={query.get('min_price')}  name="min_price" ref={minPriceRef} placeholder={'Min price'} />
            <Input onChange={onChange} defaultValue={query.get('max_price')}  name="max_price" ref={maxPriceRef} placeholder={'Max price'} />
          </Section>
